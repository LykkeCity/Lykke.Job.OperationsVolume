...
using Common;
using Common.Log;
using Lykke.Job.OperationsVolume.IncomingMessages;
using Lykke.RabbitMqBroker;
using Lykke.RabbitMqBroker.Subscriber;

namespace Lykke.Job.OperationsVolume.RabbitSubscribers
{
    public class MyRabbitSubscriber : IStartable, IStopable
    {
        ...
        public void Start()
        {
            ...
            var settings = RabbitMqSubscriptionSettings
                .CreateForSubscriber(_connectionString, "exchange-name", "operationsvolume");
